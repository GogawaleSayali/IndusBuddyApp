...
public class AuthenticationManager {
    ...
    public static void login(Activity activity) {
        ...
        Intent intent = new Intent(activity, FitbitLoginActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        intent.putExtra(FitbitLoginActivity.CLIENT_CREDENTIALS_KEY, authenticationConfiguration.getClientCredentials());
        intent.putExtra(FitbitLoginActivity.CONFIGURATION_VERSION, authenticationConfiguration.getTokenExpiresIn());
        intent.putExtra(FitbitLoginActivity.EXPIRES_IN_KEY, configVersion);
        intent.putExtra(FitbitLoginActivity.SCOPES_KEY, scopes.toArray(new Scope[scopes.size()]));
