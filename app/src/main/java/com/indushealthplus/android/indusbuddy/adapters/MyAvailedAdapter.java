...
import com.indushealthplus.android.indusbuddy.activities.healthcheckup.FeedbackActivity;
...
/**
 * Created by akshaya on 6/3/18.
 */

public class MyAvailedAdapter extends RecyclerView.Adapter<MyAvailedAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_availed_package, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyAvailedAdapter.MyViewHolder holder, int position) {
        try {
