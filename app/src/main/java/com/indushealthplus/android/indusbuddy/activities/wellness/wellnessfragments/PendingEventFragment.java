package com.indushealthplus.android.indusbuddy.activities.wellness.wellnessfragments;
...
public class PendingEventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview =  inflater.inflate(R.layout.fragment_pending_event, container, false);
        return rootview ;
    }
    ...
    public void updateDate(ArrayList<EventItemModel> events){
        ...
        if (events.size()>0) {
            ...
            if (adapter==null) {
                adapter = new PendingEventAdapter(getActivity(), events);
